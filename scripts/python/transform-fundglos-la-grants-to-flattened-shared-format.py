...
gloucestershire_CC_funding = {
    ...
    "programme/uri":	'',
    "funder/id":	'GB-GOR-GLS',
    "funder/name":	'Gloucestershire County Council',
...
gloucester_CC_funding = {
    ...
    "programme/uri":	'',
    "funder/id":	'GB-GOR-GLO',
    "funder/name":	'Gloucester City Council',
    "funder/identifier/id": ["GB-GOR-GLO"] * len(gloucester_CC),
    "funder/identifier/scheme": ["GB-GOR"] * len(gloucester_CC),
    "funder/identifier/identifier": ["GLO"] * len(gloucester_CC),
    "recipient/id":	'',
...
stroud_DC_funding = {
    ...
    "programme/uri":	'',
    "funder/id":	["GB-GOR-STO"] * len(stroud_DC),
    "funder/name":	['Stroud District Council'] * len(stroud_DC),
    "funder/identifier/id": ["GB-GOR-STO"] * len(stroud_DC),
    "funder/identifier/scheme": ["GB-GOR"] * len(stroud_DC),
    "funder/identifier/identifier": ["STO"] * len(stroud_DC),
    "recipient/id":	'',
...
dean_DC_funding = {
    ...
    "programme/description":'',	
    "programme/uri":	'',
    "funder/id":	["GB-GOR-FOE"] * len(dean_DC),
    "funder/name":	["Forest of Dean District Council"] * len(dean_DC),
...
cotswold_DC_funding = {
    ...
    "programme/uri":	'',
    "funder/id":	["GB-GOR-COT"] * len(cotswold_DC),
    "funder/name":	["Cotswold District Council"] * len(cotswold_DC),
...
cheltenham_BC_funding = {
    ...
    "programme/description":'',	
    "programme/uri":	'',
    "funder/id":	["GB-GOR-CHT"] * len(cheltenham_BC),
    "funder/name":	["Cheltenham Borough Council"] * len(cheltenham_BC),
    "funder/identifier/id": ["GB-GOR-CHT"] * len(cheltenham_BC),
    "funder/identifier/scheme": ["GB-GOR"] * len(cheltenham_BC),
    "funder/identifier/identifier":["CHT"] * len(cheltenham_BC),
    "recipient/id":	'',
...
tewkesbury_BC_funding = {
    ...
    "programme/description":'',	
    "programme/uri":	'',
    "funder/id":	["GB-GOR-TEW"] * len(tewkesbury_BC),
    "funder/name":	["Tewkesbury Borough Council"] * len(tewkesbury_BC),
